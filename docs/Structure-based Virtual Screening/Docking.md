...
- **FASTDock**: FASTDock is a pipeline for allosteric drug discovery, offering scripts and a Jupyter notebook for efficiently generating and analyzing docking grids, clusters, and fingerprint screenings.
	- [Code](https://github.com/BrooksResearchGroup-UM/FASTDock) : Last updated in June 2023, 12 months ago
	- [Publication](https://doi.org/10.26434/chemrxiv-2023-7c43h) : Citations: 0.0
...
- **CBDock2**: CBDock2 is an improved protein-ligand blind docking tool integrating cavity detection, docking, and homologous template fitting to suggest novel therapeutic targets for biological and pharmaceutical studies.
	- [Publication](https://doi.org/10.1093/nar/gkac394) : Citations: 275.0
...
- **AutoDock Vina**: 
	...
	- [Publication](https://doi.org/10.1021/acs.jcim.1c00203) : Citations: 1783.0
...
- **BR-NiB**: Brute Force Negative Image-Based Optimization. A docking rescoring method that relyes on shape/ electrostatic potential similarity between the docking poses of ligands and the cavity-based negative images (standalone).
	...
	- [Publication](https://doi.org/10.1021/acs.jcim.1c01145) : Citations: 2.0
- **DockThor**: 
...
- **FitDock**: protein–ligand docking by template fitting (Linux or Windows, need registration) (standalone).
	- [Publication](https://doi.org/10.1093/bib/bbac087) : Citations: 51.0
...
- **GeauxDock**: An ultra-fast automated docking program from LSU, predicting how small ligands bind to macromolecules using a novel hybrid force field and a Monte Carlo protocol.
	...
	- [Publication](https://doi.org/10.1371/journal.pone.0158898) : Citations: 23.0
	- [Link](https://www.brylinski.org/geauxdock)
- **GLOW-IVES**: Provides Python implementation of GLOW (auGmented sampLing with softened vdW potential) and IVES (Iterative Ensemble Sampling) protocols for pose sampling, along with new cross-docking datasets.
	- [Code](https://github.com/drorlab/GLOW_IVES) : Last updated in December 2023, 6 months ago
- **HESS**: 
	- [Code](https://github.com/Entroforce/Hess) : Last updated in December 2023, 5 months ago
	- [Publication](https://doi.org/10.26434/chemrxiv-2023-jh1kk) : Citations: 0.0
- **JAMDA**: 
	- [Publication](https://doi.org/10.1021/acs.jcim.3c01573) : Citations: 3.0
...
- **labodock**: LABODOCK offers a collection of Jupyter Notebooks for molecular docking on Google Colab with minimal coding, streamlining pre- and post-docking processes.
	...
	- [Publication](https://doi.org/10.5281/zenodo.8246977-blue) : Citations: 0.0
- **MzDock**: 
	- [Code](https://github.com/Muzatheking12/MzDOCK) : Last updated in May 2024, 1 months ago
	- [Publication](https://doi.org/10.1002/jcc.27390) : Citations: 0.0
- **PANTHER**: A tool designed for effective virtual screening, considering protein structure flexibility and physico-chemical properties, and available under a GPL license.
	- [Publication](https://doi.org/10.1007/s10822-015-9870-3) : Citations: 31.0
	- [Link](https://www.medchem.fi/panther/)
- **parallel-PLANTS**: Offers a method for parallel molecular docking using the PLANTS software, aimed at academic use.
	- [Code](https://github.com/discoverdata/parallel-PLANTS) : Last updated in August 2018, 71 months ago
- **ProBiS-Dock**: A Hybrid Multitemplate Homology Flexible Docking Algorithm Enabled by Protein Binding Site Comparison (standalone).
	- [Code](https://gitlab.com/janezkonc/insidrug/-/releases/probis_dock_algorithm_v1.0.0) : Last updated in nan, nan
	- [Publication](https://doi.org/10.1021/acs.jcim.1c01176) : Citations: 5.0
	- [Link](http://insilab.org/probisdock)
- **QVINA**: QuickVina 2 aims to accurately speed up AutoDock Vina, providing up to 20.49-fold acceleration with high correlation in binding energy prediction.
	- [Code](https://github.com/QVina/qvina) : Last updated in November 2022, 19 months ago
	- [Publication](https://doi.org/10.1093/bioinformatics/btv082) : Citations: 190.0
- **RDPSO_Vina**: A fast docking tool utilizing random drift particle swarm optimization based on the AutoDock Vina and PSOVina framework.
	...
	- [Publication](https://doi.org/10.1007/s10822-022-00455-4) : Citations: 3.0
- **restretto**: Effective Protein–Ligand Docking Strategy via Fragment Reuse and a Proof-of-Concept Implementation (standalone).
	...
	- [Publication](https://doi.org/10.1021/acsomega.2c03470) : Citations: 3.0
- **RxDock**: a fast, versatile, and open-source program for docking ligands to proteins and nucleic acids (standalone).
	...
	- [Publication](https://doi.org/10.1371/journal.pcbi.1003571) : Citations: 390.0
- **SMINA**: A fork of AutoDock Vina that supports scoring function development and high-performance energy minimization, maintained by the University of Pittsburgh.
	...
	- [Publication](https://doi.org/10.1021/ci300604z) : Citations: 654.0
- **Uni-Dock**: Uni-Dock is a GPU-accelerated molecular docking program that supports various scoring functions and achieves significant speed-up compared with AutoDock Vina on a single CPU core.
	...
	- [Publication](https://doi.org/10.1021/acs.jctc.2c01145) : Citations: 18.0
...
- **VinaGPU2.0**: 
	...
	- [Publication](https://doi.org/10.1021/acs.jcim.2c01504) : Citations: 22.0
- **VinaXB (halogen-bonding)**: Introduces a halogen bonding scoring function (XBSF) in AutoDock Vina, termed AutoDock VinaXB, to improve docking accuracy with halogenated ligands.
	...
	- [Publication](https://doi.org/10.1186/s13321-016-0139-1) : Citations: 97.0
...
- **dockECR**: 
	...
	- [Publication](https://doi.org/10.1016/j.jmgm.2021.108023) : Citations: 9.0
...
- **VoteDock**: 
	- [Publication](https://doi.org/10.1002/jcc.21642) : Citations: 73.0
...
- **ADFR**: AutoDockFR is a protein-ligand docking program supporting selective receptor flexibility and covalent docking, part of the ADFR suite for streamlined docking procedures.
	- [Publication](https://doi.org/10.1371/journal.pcbi.1004586) : Citations: 307.0
	- [Link](https://ccsb.scripps.edu/adfr/)
- **DSDPFlex**: 
	- [Code](https://github.com/PKUGaoGroup/DSDP) : Last updated in June 2024, 0 months ago
	- [Publication](https://doi.org/10.26434/chemrxiv-2023-bcw0g-v2) : Citations: 0.0
...
- **FlexAID**: 
	...
	- [Publication](https://doi.org/10.1021/acs.jcim.5b00078) : Citations: 49.0
- **GNINA**: GNINA is a molecular docking program that incorporates scoring and optimization of ligands using convolutional neural networks, aiming to combine the versatility of smina and AutoDock Vina with the predictive power of deep learning.
	...
	- [Publication](https://doi.org/10.1186/s13321-021-00522-2) : Citations: 199.0
- **iDock**: iDock is a multithreaded virtual screening tool for flexible ligand docking in computational drug discovery, inspired by AutoDock Vina and hosted on GitHub under Apache License 2.0.
	...
	- [Publication](https://doi.org/10.1109/CIBCB.2012.6217214) : Citations: 59.0
- **PackDock**: Describes PackDock as a diffusion-based side chain packing model for flexible protein-ligand docking, indicating code will be available following the publication of their paper.
	...
	- [Publication](https://doi.org/10.1101/2024.01.31.578200) : Citations: 0.0
...
- **POAP**: 
	...
	- [Publication](https://doi.org/10.1016/j.compbiolchem.2018.02.012) : Citations: 61.0
- **VinaLC**: 
	- [Code](https://github.com/XiaohuaZhangLLNL/VinaLC) : Last updated in September 2018, 69 months ago
	- [Publication](http://onlinelibrary.wiley.com/doi/10.1002/jcc.23214/abstract) : Citations: 0.0
- **VinaMPI**: 
	- [Publication](https://doi.org/10.1002/jcc.23367) : Citations: 59.0
- **VinaSC**: 
	- [Publication](https://doi.org/10.1109/BIBM.2016.7822624) : Citations: 0.0

## MD-based
- **ColDock**: 
	- [Publication](https://doi.org/10.1021/acs.jpcb.8b02756) : Citations: 14.0
...
- **AQDNet**: Implements a Deep Neural Network for Protein-Ligand Docking Simulation, focusing on identifying correct binding poses through convolutional neural network approaches.
	...
	- [Publication](https://doi.org/10.1021/acsomega.3c02411) : Citations: 4.0
- **CarsiDock**: a deep learning paradigm for accurate protein–ligand docking and screening based on large-scale pre-training (standalone, 2024).
	...
	- [Publication](https://doi.org/10.1039/D3SC05552C) : Citations: 3.0
- **DeepBindBC**: A practical deep learning method for identifying native-like protein-ligand complexes in virtual screening (online).
	- [Publication](https://doi.org/10.1016/j.ymeth.2022.07.009) : Citations: 14.0
...
- **DiffBindFR**: 
	...
	- [Publication](https://doi.org/10.1039/D3SC06803J) : Citations: 0.0
...
- **EViS**: EViS is an enhanced virtual screening method integrating ligand docking, protein pocket template searching, and ligand template shape similarity calculations, utilizing a novel PL-score for evaluation.
	- [Code](https://github.com/JingHuangLab/EViS) : Last updated in December 2021, 30 months ago
	- [Publication](https://doi.org/10.1021/acs.jcim.1c00944) : Citations: 5.0
- **FABind**: 
...
- **GAABind**: GAABind is a Geometry-Aware Attention-Based Network for accurate protein-ligand binding pose and binding affinity prediction, featuring a comprehensive environment setup and dataset processing guide.
	...
	- [Publication](https://doi.org/10.1093/bib/bbad462) : Citations: 0.0
- **GNINA**: GNINA is a molecular docking program that incorporates scoring and optimization of ligands using convolutional neural networks, aiming to combine the versatility of smina and AutoDock Vina with the predictive power of deep learning.
	- [Code](https://github.com/gnina/gnina) : Last updated in May 2024, 0 months ago
	- [Publication](https://doi.org/10.1186/s13321-021-00522-2) : Citations: 199.0
- **GNINA_KD**: 
	- [Code](https://github.com/YanjingLiLi/GNINA_Knowledge_Distillation) : Last updated in April 2024, 2 months ago
	- [Publication](https://doi.org/10.26434/chemrxiv-2024-0jh8g) : Citations: 0.0
- **gnina-torch**: A PyTorch implementation of the GNINA molecular docking scoring function, designed for enhanced performance and adaptability.
	- [Code](https://github.com/RMeli/gnina-torch/tree/0.0.2?tab=readme-ov-file) : Last updated in May 2023, 13 months ago
	- [Publication](https://doi.org/10.5281/zenodo.6943066) : Citations: 0.0
- **Interformer**: code to be released, a unified model built upon the Graph-Transformer architecture, which specially crafted to capture non-covalent interactions through the interaction-aware mixture density network
	- [Publication](http://dx.doi.org/10.21203/rs.3.rs-3995849/v1) : Citations: 0.0
...
- **KarmaDock**: 
	...
	- [Publication](https://doi.org/10.1038/s43588-023-00511-5) : Citations: 17.0
...
- **PLANTAIN**: Predicting LigANd pose wiTh an AI scoring functioN
	- [Code](https://github.com/molecularmodelinglab/plantain) : Last updated in February 2024, 4 months ago
	- [Publication](https://arxiv.org/abs/2307.12090) : Citations: N/A
- **PointVS**: SE(3)-equivariant point cloud networks designed for virtual screening, enabling E(3)-invariant predictions of binding pose and affinity using networks based on the EGNN graph neural network layer.
	- [Code](https://github.com/jscant/PointVS) : Last updated in April 2023, 13 months ago
	- [Publication](https://doi.org/10.1101/2022.10.28.511712) : Citations: 0.0
- **SurfDock**: Surface-Informed Diffusion Generative Model for Reliable and Accurate Protein-ligand Complex Prediction
	- [Code](https://github.com/CAODH/SurfDock) : Last updated in December 2023, 6 months ago
	- [Publication](https://doi.org/10.1101/2023.12.13.571408) : Citations: 1.0
...
- **TopoFormer**: A topological transformer for protein-ligand complex interaction prediction, integrating multiscale topology techniques with a structure-to-sequence transformer model.
	- [Code](https://github.com/WeilabMSU/TopoFormer) : Last updated in May 2024, 0 months ago
	- [Publication](https://doi.org/10.5281/zenodo.10892800.svg) : Citations: 0.0
...
- **Uni-Mol v2**: 
	- [Code](https://github.com/dptech-corp/Uni-Mol) : Last updated in June 2024, 0 months ago
	- [Publication](https://openreview.net/forum?id=6K2RM6wVqKu) : Citations: N/A
	- [Link](https://bohrium.dp.tech/apps/unimoldockingv2)
- **vScreenML**: A machine learning classifier designed for virtual screening, allowing for the rescoring of hits to eliminate false positives, based on the Dataset of Congruent Inhibitors and Decoys (D-COID).
	- [Code](https://github.com/karanicolaslab/vScreenML) : Last updated in July 2020, 47 months ago
	- [Publication](https://doi.org/10.1101/2020.01.10.902411v1.full.pdf) : Citations: 0.0

## MetalloProteins
- **MetalDock**: 
	- [Code](https://github.com/MatthijsHak/MetalDock) : Last updated in May 2024, 0 months ago
	- [Publication](https://doi.org/10.1021/acs.jcim.3c01582) : Citations: 3.0

## Multi-Ligand
- **HARMONICFlow**: 
	- [Code](https://github.com/HannesStark/FlowSite) : Last updated in May 2024, 0 months ago
	- [Publication](https://arxiv.org/abs/2310.05764) : Citations: N/A
...
- **DeepRMSD-Vina**: DeepRMSD+Vina is a computational framework integrating ligand binding pose optimization and screening, utilizing deep learning alongside the classical Vina scoring function.
	...
	- [Publication](https://doi.org/10.1093/bib/bbac520) : Citations: 22.0
...
- **EquiDock**: EquiDock employs geometric deep learning for fast and accurate rigid 3D protein-protein docking, focusing on efficiency and accessibility with comprehensive preprocessing and training guidelines.
	- [Code](https://github.com/octavian-ganea/equidock_public) : Last updated in April 2022, 26 months ago
	- [Publication](https://doi.org/10.48550/arXiv.2111.07786) : Citations: 0.0
- **LightDock**: The open-source macromolecular docking framework written in Python
	- [Code](https://github.com/lightdock) : Last updated in nan, nan
	- [Publication](https://doi.org/10.1093/bioinformatics/btx555) : Citations: 77.0

## Quantum
- **Zhang et al.**: 
	- [Publication](https://doi.org/10.1021/acs.jctc.3c00943) : Citations: 1.0
...
- **MolModa**: accessible and secure molecular docking in a web browser.
	- [Publication](https://doi.org/10.1093/nar/gkae406) : Citations: 0.0
	- [Link](https://durrantlab.com/molmoda)
