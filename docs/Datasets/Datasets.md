...
- **[RADER](http://www.idruglab.com/rader/)**: a RApid DEcoy Retriever to facilitate decoy based assessment of virtual screening (online)
...
- **[ProtCAD](https://idrblab.org/drugmap/)**: a comprehensive structural resource of protein complexes (online)
...
- **[Natural product subsets (DIFACQUIM)](https://github.com/DIFACQUIM/Natural-products-subsets-generation)**: Natural product datasets (diverse with Python code to generate diversity) (dataset)
- **[PeruNPDB](https://perunpdb.com.pe/)**: the Peruvian Natural Products Database for in silico drug screening (database)
- **[npatlas](https://www.npatlas.org/)**: The Natural Products Atlas 2.0: A Database of Microbially-Derived Natural Products (online)
- **[TCMSID](https://tcm.scbdd.com/)**: a simplified integrated database for drug discovery from traditional chinese medicine (online)
- **[YaTCM](http://cadd.pharmacy.nankai.edu.cn/yatcm/home)**: Yet another Traditional Chinese Medicine Database for Drug Discovery (online)
- **[BIOFACQUIM](https://www.difacquim.com/d-tools/)**: novel compounds databse with natural products isolated and charcterized in Mexico (online)
- **[Super Natural II](http://bioinf-applied.charite.de/supernatural_new/index.php)**: a database of natural products (online)
- **[HIT](http://lifecenter.sgst.cn/hit/)**: Herbal Ingredients' Targets Database (online)
- **[HIT 2.0](http://hit2.badd-cao.net/)**: an enhanced platform for Herbal Ingredients' Targets (online)
- **[VIETHERB](http://vietherb.com.vn/)**: A Database for Vietnamese Herbal Species - Natural products (online)
- **[TCM Database@Taiwan](http://tcm.cmu.edu.tw/)**: the world's largest traditional Chinese medicine database for drug screening in silico (online)
- **[iSMART](http://ismart.cmu.edu.tw/)**: an integrated cloud computing web server for traditional Chinese medicine for online virtual screening, de novo evolution and drug design (online)
- **[Nubbe](http://nubbe.iq.unesp.br/portal/nubbe-search.html)**: a natural products database from the biodiversity of Brazil (online)
## Chemical
...
- **[MCULE](https://mcule.com/database/)**: Commercial compound collection (online)
- **[Molport](https://www.molport.com/shop/index)**: commercially-available compounds
- **[eMolecules](https://www.emolecules.com/)**: commercially-available compounds
- **[ChemSpider](http://www.chemspider.com/)**: commercially-available compounds
- **[ZINC20](http://zinc20.docking.org/)** A Free Ultralarge-Scale Chemical Database for Ligand Discovery (online)
- **[Zinc](http://zinc15.docking.org/)**: a free database of commercially-available compounds
- **[ZINC Express](https://zincexpress.mml.unc.edu/)**: A Virtual Assistant for Purchasing Compounds Annotated in the ZINC Database (online)
## Protein Structures
...
- **[MISATO](https://zenodo.org/records/7711953)**: machine learning dataset of protein–ligand complexes for structure-based drug discovery
- **[PLAS-5k](https://hai.iiit.ac.in/datasets.html)**: Dataset of Protein-Ligand Affinities from Molecular Dynamics for Machine Learning Applications (5000 protein-ligand complexes) (dataset).
...
- **[KIBA](https://researchportal.helsinki.fi/fi/datasets/kiba-a-benchmark-dataset-for-drug-target-prediction)**: An integrated drug–target bioactivity matrix across 52498 chemical compounds and 467 kinase targets (dataset)
- **[KinCoRe](http://dunbrack.fccc.edu/kincore/)**: A web resource for protein kinase sequence, structure and phylogeny (online)
- **[KinaseMD](https://bioinfo.uth.edu/kmd/)**: kinase mutations and drug response database (online)
- **[KLIFS](https://klifs.vu-compmedchem.nl/)**: Kinase-Ligand Interaction Fingerprints and Structures database is a database that revolves around the protein structure of catalytic kinase domains and the way kinase inhibitors can interact with them (online database)
- **[CORAL](http://phanstiel-lab.med.unc.edu/CORAL/)**: Clear and customizable visualization of human kinome data (Kinase) (online)
- **[KinMap](http://www.kinhub.org/kinmap/)**: a web-based tool for interactive navigation through human kinome data (kinase) (online)
- **[ProfKin](http://www.lilab-ecust.cn/profkin/)**: A Comprehensive Web Server for Structure-based Kinase Selectivity Profiling (online)
- **[KinBase](http://kinase.com/kinbase/)**: kinase (online)
- **[Kinome Render](http://biophys.umontreal.ca/nrg/resources.html)**: look at kinase family (standalone)
- **[Kinase Atlas](https://kinase-atlas.bu.edu/)**: contains solvent mapping results for all kinases in the Protein Data Bank. You can search this database by PDB ID or by UniProt accession number (online)
## PROTACs

- **[PROTAC-DB](http://cadd.zju.edu.cn/protacdb/)**: an online database of PROTACs (online)
	- **[PROTAC-DB 2.0](http://cadd.zju.edu.cn/protacdb/)**: an updated database of PROTACs (online)


## GPCRs

- **[GproteinDb](https://gproteindb.org/)**: The G protein database (online)

## Protein Targets

- **[OpenTargets](https://www.opentargets.org/)**: A partnership to transform drug discovery through the systematic identification and prioritisation of targets