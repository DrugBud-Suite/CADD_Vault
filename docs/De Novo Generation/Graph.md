...
- **HyFactor (Hydrogen-count Labelled Graph-based Defactorization Autoencoder)**: An open-source architecture for structure generation using graph-based approaches, focusing on a new molecular graph type that considers hydrogen counts for enhanced molecular representation and generation.  
    ...
    [![Publication](https://img.shields.io/badge/Publication-Citations:1-blue?style=for-the-badge&logo=bookstack)](https://doi.org/10.26434/chemrxiv-2021-18x0d) 
...
- **EquiBoost**: Equivariant Boosting Approach to Molecular Conformation Generation  
    [![Code](https://img.shields.io/github/stars/foralan/EquiBoost?style=for-the-badge&logo=github)](https://github.com/foralan/EquiBoost) 
    [![Last Commit](https://img.shields.io/github/last-commit/foralan/EquiBoost?style=for-the-badge&logo=github)](https://github.com/foralan/EquiBoost) 

    [![Publication](https://img.shields.io/badge/Publication-Citations:0-blue?style=for-the-badge&logo=bookstack)](https://doi.org/10.48550/arXiv.2501.05109) 
